          ...
          <div class="card-body">
            ...
            <form class="row g-3" action="/update-user/{{$user->id}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-md-6">
                ...
                <select id="inputState" class="form-select" name="role" value="{{$user->level}}" placeholder="Enter Role...">
              ...
              <div class="col-md-6">
                ...
                <select id="inputState" class="form-select" name="status" value="{{$user->level}}" placeholder="Enter Status...">
