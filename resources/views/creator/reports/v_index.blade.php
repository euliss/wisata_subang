                ...
                <div class="col-lg-12">
                    <div class="card p-3">
                        <div class="card-header">
                            <h3 class="card-title">Laporan Pengunjung Destinasi {{ $destination->name }}</h3>
                            <a href="/report/export_excel_report" class="btn btn-success"
                                style="float: right; margin: 0 8px"><i class="bi bi-folder-symlink"></i>
                                Export</a>
                            <a href="/add-reports/{{ $destination->id }}" class="btn btn-primary" style="float: right"><i
                                    class="bi bi-plus-circle-fill"></i> Tambah Data</a>
                            {{-- <a href="{{ url('detail-destinations/'.$destination->id) }}" class="btn btn-primary"><i class="bi bi-arrow-left-circle"></i> Detail Destinasi</a> --}}
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="" class="row mt-4 mb-5">
                                ...
                                <div class="col-sm-12 mt-3">
                                    ...
                                    <a class="btn btn-secondary"
                                        href="/reports-destination/{{ Request::segment(2) }}">Reset</a>
                                </div>
                            </form>
                        </div>
                        <div class="card-body">
