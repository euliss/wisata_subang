            ...
            categories.forEach(function(category) {
              ...
              navbarNav.appendChild(li);
                    ...
                    <li class="nav-item"><a href="/"
                            class="nav-link"><span>{{ GoogleTranslate::trans('Beranda', app()->getLocale()) }}</span></a>
                    </li>
                    <li class="nav-item"><a
                            href="<?= Request::segment(1) == '' ? '#destinasi' : url('/') . '#destinasi' ?>"
                            class="nav-link"><span>{{ GoogleTranslate::trans('Pariwisata', app()->getLocale()) }}</span></a>
                    </li>
                    <li class="nav-item"><a href="/about"
                            class="nav-link"><span>{{ GoogleTranslate::trans('Berita', app()->getLocale()) }}</span></a>
                    </li>
                    @if (auth()->user())
                        <li class="nav-item"><a href="/dashboard"
                                class="nav-link"><span>{{ GoogleTranslate::trans('Dashboard', app()->getLocale()) }}</span></a>
                        </li>
                    @else
                        <li class="nav-item"><a href="/login"
                                class="nav-link"><span>{{ GoogleTranslate::trans('Login', app()->getLocale()) }}</span></a>
                        </li>
                    @endif
                    <li class="nav-item" style="padding-top:6px">
                        <div class="dropdown">
            ...
            <div class="row mb-3">
                <div class="col-md">
                    <div class="ftco-footer-widget mb-2">
                        ...
                        <p> Dinas Pariwisata Pemuda dan Olahraga Kabupaten Subang </p>
                        <p> Informasi Lebih Lanjut :</p>
                        <a href="https://wa.me/085863518629" class="btn btn-success"><i class="ion-logo-whatsapp"></i>
                            Hubungi Kami</a>
                    </div>
                </div>
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4 ml-md-4">
                        ...
                        <p>Jl. Jend. Achmad Yani No.11, Pasirkareumbi, Kec. Subang Kabupaten Subang Jawa Barat</p>
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.5801145580176!2d107.75470330968386!3d-6.574555993391404!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e693cbc83e65e4f%3A0x1d6f46b5875bd277!2sDinas%20Kebudayaan%20Pariwisata%20Pemuda%20Dan%20Olah%20Raga!5e0!3m2!1sid!2sid!4v1687158543166!5m2!1sid!2sid"
