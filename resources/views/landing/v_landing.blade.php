...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 ftco-animate">
            <div class="project">
              <div class="img">
                <div class="vr"><span>Sale</span></div>
                <a href="hotel.html"><img src="{{ asset('ecoland/images/hotel-1.jpg') }}" class="img-fluid" alt="Colorlib Template"></a>
              </div>
              <div class="text">
                <h4 class="price"><span class="old-price mr-2">$500</span>$400</h4>
                <span>3 nights</span>
          ...
          <div class="col-md-6 col-lg-4 ftco-animate">
            <div class="project">
              <div class="img">
                <a href="hotel.html"><img src="{{ asset('ecoland/images/hotel-2.jpg') }}" class="img-fluid" alt="Colorlib Template"></a>
              </div>
              <div class="text">
                <h4 class="price">$400</h4>
                <span>3 nights</span>
          ...
          <div class="col-md-6 col-lg-4 ftco-animate">
            <div class="project">
              <div class="img">
                <a href="hotel.html"><img src="{{ asset('ecoland/images/hotel-3.jpg') }}" class="img-fluid" alt="Colorlib Template"></a>
              </div>
              <div class="text">
                <h4 class="price">$400</h4>
                <span>3 nights</span>
    ...
    <section class="ftco-section testimony-section">
      <img src="{{ asset('ecoland/images/blob-shape-2.svg') }}" class="svg-blob" alt="Colorlib Free Template">
      <img src="{{ asset('ecoland/images/blob-shape-2.svg') }}" class="svg-blob-2" alt="Colorlib Free Template">
      <div class="container">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 ftco-animate">
            <div class="project">
              <div class="img">
                <img src="{{ asset('ecoland/images/resto-1.jpg') }}" class="img-fluid" alt="Colorlib Template">
              </div>
              <div class="text">
          ...
          <div class="col-md-6 col-lg-4 ftco-animate">
            <div class="project">
              <div class="img">
                <img src="{{ asset('ecoland/images/resto-2.jpg') }}" class="img-fluid" alt="Colorlib Template">
              </div>
              <div class="text">
                <h4 class="price"><span class="mr-2">menu start at</span>$4.00</h4>
                <span>Bern, Swetzerland</span>
          ...
          <div class="col-md-6 col-lg-4 ftco-animate">
            <div class="project">
              <div class="img">
                <img src="{{ asset('ecoland/images/resto-3.jpg') }}" class="img-fluid" alt="Colorlib Template">
              </div>
              <div class="text">
                <h4 class="price"><span class="mr-2">menu start at</span>$4.00</h4>
                <span>Bern, Swetzerland</span>
